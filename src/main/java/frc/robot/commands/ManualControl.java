...
public class ManualControl extends CommandBase {
  ...
  public void execute() {
    ...
    m_subsystem.driveWithField(signedSqr(ySpeed) * MAXINPUTWHEELMOTOR,signedSqr(xSpeed)* MAXINPUTWHEELMOTOR, signedSqr(rSpeed)*MAXINPUTWHEELMOTOR,GYRO.getRotation2d().unaryMinus()); //X and Y is swapped in Controller vs Robot axis
  }
